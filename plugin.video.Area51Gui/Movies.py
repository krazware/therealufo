...
#############################################################
#################### SET ADDON ID ###########################
_addon_id_	= 'plugin.video.WiseGuys'
...
def Load_Vod(self):
	...
	Movie_dates		=	[]
	Movie_ids.append('')
	Movie_titles.append('[COLOR red]Limitless VOD[/COLOR]')
	Movie_types.append('[COLOR red]Limitless VOD[/COLOR]')
	Movie_dates.append('[COLOR red]Limitless VOD[/COLOR]')
	Movie_posters.append(Icon)
	self.VOD_LIST.addItem('[COLOR red]Limitless VOD[/COLOR]')
	try:
...
class Movies(pyxbmct.AddonFullWindow):
	...
	def __init__(self, title='WiseGuys'):
