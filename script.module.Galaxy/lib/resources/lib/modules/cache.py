...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Galaxy Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.Galaxy')
    ...
    try:
        curVersion = control.addon('script.module.Galaxy').getAddonInfo('version')
